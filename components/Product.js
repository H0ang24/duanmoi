...
export default function Product({ product }) {
    ...
    const giamGia = (product.variants[0].compare_at_price ?? product.variants[0].price)
            ...
            <div className=''>
                ...
                <div className='flex flex-col gap-1'>
                    ...
                    <div className='flex gap-3'>
                        {
                            product.variants[0].compare_at_price && <del className='text-gray-500 font-bold'>{product.variants[0].compare_at_price}$</del>
                        }
